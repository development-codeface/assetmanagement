...
var deviceInfo     = {
  "RFID658" : {
       name : "Computer",brand : "Apple" ,model : "Mac Pro",type : "rental","id":"RFID658"
  },
  "RFID765" : {
       name : "Mobile",brand : "Samsung" ,model:"Samsung S8",type : "rental","id":"RFID765"
  },
  "RFID678" : {
       name : "Mobile",brand : "Apple" ,model : "Iphone 10",type : "rental","id":"RFID658"
  }
}
...
var updateViolation  = function(data,timestamp){
    for(var i=0 ; i < data.length ; i++){
      if(data[i].violate == "YES"){
        ...
        plotImage (ploterid,ploterImage,true,data[i].exitId);
      }
    }
}
...
var showDeviceInfo  = function (roomId){
  ...
  $("#device_brand").text(deviceDetail.brand);
  $("#device_model").text(deviceDetail.model);
  $("#device_id").text(deviceDetail.id)
  $("#temp_device_View").modal("show");
}
